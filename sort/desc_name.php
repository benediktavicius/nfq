...
<body>
  ...
  $sql="SELECT * FROM books ORDER BY book_name DESC LIMIT $page1,10";
  ...
  <div class="container">
    <table class="table table-hover">
      <thead>
        <tr>
          <th>Name<a href="../sort/asc_name.php" class="glyphicon glyphicon-triangle-bottom"></a><a href="../sort/desc_name.php" class="glyphicon glyphicon-triangle-top text-muted"></a></th>
    ...
    <div class="pagination">
      ...
      for($b=1;$b<=$a;$b++)
      {
        ?><a href="desc_name.php?page=<?php echo $b; ?>"><?php echo $b . " "; ?></a><?php
      }
