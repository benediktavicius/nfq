...
<body>
  ...
  $sql="SELECT * FROM books ORDER BY book_author DESC LIMIT $page1,10";
    ...
    <table class="table table-hover">
      <thead>
        <tr>
          ...
          <th>Author<a href="../sort/asc_author.php" class="glyphicon glyphicon-triangle-bottom"></a><a href="../sort/desc_author.php" class="glyphicon glyphicon-triangle-top text-muted"></a></th>
