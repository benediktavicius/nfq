...
<body>
  ...
  $sql="SELECT * FROM books ORDER BY book_author ASC LIMIT $page1,10";
    ...
    <table class="table table-hover">
      <thead>
        <tr>
          ...
          <th>Author<a href="../sort/asc_author.php" class="glyphicon glyphicon-triangle-bottom text-muted"></a><a href="../sort/desc_author.php" class="glyphicon glyphicon-triangle-top"></a></th>
